  ...
  return (
    <main className="mx-auto max-w-6xl px-6 py-24">
      <div className="max-w-2xl rounded-3xl border border-slate-800 bg-slate-900/60 p-8 sm:p-10">
        <p className="text-brand-400 text-sm font-semibold">{roleName} dashboard</p>
        <h1 className="mt-3 text-3xl font-bold text-white">You are signed in</h1>
        <p className="mt-4 leading-7 text-slate-400">
          Your account has been authorized for this role. Dashboard features will appear here in the
          next frontend phase.
        </p>
      </div>
    </main>
